...
while True:
    ...
    if opcion == "1":
        ...
        id = input("Introduce el id del cliente que desees actualizar: ")
        nombre = input("Introduce el nombre nuevo cliente:")        # le pido todos los datos y los almacenos en una variable
        email = input("Introduce el mail nuevo cliente:")
        poblacion = input("Introduce la pobalcion del nuevo cliente:")
        fechadenacimiento = input("Introduce la fecha de nacimento del nuevo cliente:")
        peticion = "UPDATE clientes VALUES (NULL,'"+nombre+"','"+email+"','"+poblacion+"','"+fechadenacimiento+"');"    #preparp peticion
