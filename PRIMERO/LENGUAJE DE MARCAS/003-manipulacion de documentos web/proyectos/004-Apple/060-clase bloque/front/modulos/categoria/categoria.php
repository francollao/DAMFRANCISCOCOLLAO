<main>
	<?php 
		...
		$bloque1 = new BloqueCompleto("bloque1","sub1","aaaaaaaaaaaaa","","");
		echo $bloque1 ->getBloque();


		$bloque2 = new BloqueCaja("bloque2","sub2","aaaaaaaaaaaaa","","");
		echo $bloque2 ->getBloque();
		

		$bloque3 = new BloqueCompleto("bloque3","sub4","aaaaaaaaaaaaa","","");
