...
//este archivo carga el contenido interno de las tablas 
	...
	while ($fila = $resultado->fetch_assoc()) {
		...
		foreach($fila as $clave=>$valor){		//para cada uno de los campos
			if($clave == "indentificador"){	//si el campo es menor de 300caracteres
		...
		</td>";//creamos un boton en una nueva columna para cada una de las filas, que nos llevara a la pagina eliminar.php. de la $tabla
